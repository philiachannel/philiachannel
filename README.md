...
Python・VBA・GAS・Claudeを使った**業務自動化**が得意なフリーランスエンジニアです。<br>
...
### 🔧 [プロジェクト名①](https://github.com/（ユーザー名）/（リポジトリ名）)
> VBAで月次集計レポートの作成を自動化。作業時間を毎月5時間→15分に短縮。
...
### 🔧 [プロジェクト名②](https://github.com/（ユーザー名）/（リポジトリ名）)
> GASでGoogleフォームの自動集計・メール通知システムを構築。手動対応ゼロを実現。

**使用技術：** GAS / Google Forms / Gmail

---

### 🔧 [プロジェクト名③](https://github.com/（ユーザー名）/（リポジトリ名）)
> Pythonで請求書PDFを自動生成・メール送信するツールを開発。月30件の請求作業を自動化。

**使用技術：** Python / reportlab / smtplib
